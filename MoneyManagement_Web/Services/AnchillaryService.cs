...
public class AnchillaryService : IAnchillaryService
{
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/Country/GetCountryList", string.Empty));
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/Country/GetCountry/{id}", string.Empty));
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/Country/UpdateCountry", string.Empty));
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/Country/AddCountry", string.Empty));
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/Country/DeleteCountry", string.Empty));
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/Currency/GetCurrencyList", string.Empty));
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/Currency/GetCurrency/{id}",
            string.Empty));
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/Currency/UpdateCurrency", string.Empty));
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/Currency/AddCurrency", string.Empty));
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/Currency/DeleteCurrency", string.Empty));
    ...
    public async Task<List<CurrencyConversionRate>> GetActiveCurrencyConversionList()
    {
        var uri = new Uri(string.Format(
            _utilityServices.GetRestUrl() + $"api/CurrencyConversion/GetCurrencyConversionList", string.Empty));
    ...
    {
        var uri = new Uri(string.Format(
            _utilityServices.GetRestUrl() + $"api/CurrencyConversion/GetCurrencyConversion/{id}", string.Empty));
    ...
    {
        var uri = new Uri(string.Format(
            _utilityServices.GetRestUrl() + $"api/CurrencyConversion/UpdateCurrencyConversion", string.Empty));
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/CurrencyConversion/AddCurrencyConversion",
            string.Empty));
    ...
    {
        var uri = new Uri(string.Format(
            _utilityServices.GetRestUrl() + $"api/CurrencyConversion/DeleteCurrencyConversion", string.Empty));
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/CurrencyConversion/UpdateCurrencyRate",
            string.Empty));
        var dataResponse = new CurrencyConversionRate();
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/CurrencyConversion/ClearUnusedRates",
            string.Empty));
        var dataResponse = new CurrencyConversionRate();
    ...
    {
        var uri = new Uri(string.Format(
            _utilityServices.GetRestUrl() + $"api/CurrencyConversion/GetCurrencyRate/{currencyALF3}", string.Empty));
        var dataResponse = new CurrencyConversionRate();
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/ServiceUser/GetServiceUserList",
            string.Empty));
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/ServiceUser/GetServiceUser/{id}",
            string.Empty));
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/ServiceUser/UpdateServiceUser",
            string.Empty));
    ...
    {
        var uri = new Uri(
            string.Format(_utilityServices.GetRestUrl() + $"api/ServiceUser/AddServiceUser", string.Empty));
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/ServiceUser/DeleteServiceUser",
            string.Empty));
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/Supplier/GetSupplierList", string.Empty));
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/Supplier/GetSupplier/{id}",
            string.Empty));
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/Supplier/UpdateSupplier", string.Empty));
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/Supplier/AddSupplier", string.Empty));
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/Supplier/DeleteSupplier", string.Empty));
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/ReadInBill/GetReadInBillList",
            string.Empty));
    ...
    {
        var uri = new Uri(string.Format(
            _utilityServices.GetRestUrl() + $"api/ReadInBill/GetActiveReadInBillBySupplierList/{id}", string.Empty));
        var dataResponse = new List<ReadInBill>();
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/ReadInBill/GetReadInBill/{id}",
            string.Empty));
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/ReadInBill/UpdateReadInBill",
            string.Empty));
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/ReadInBill/AddReadInBill", string.Empty));
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/ReadInBill/DeleteReadInBill",
            string.Empty));
