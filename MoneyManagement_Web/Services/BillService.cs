...
public class BillService : IBillService
{
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/Bill/GetBillList", string.Empty));
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/Bill/GetBill/{id}", string.Empty));
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/Bill/UpdateBill", string.Empty));
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/Bill/CategoryConfirmed", string.Empty));
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/Bill/AddBill", string.Empty));
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/Bill/UploadCsv", string.Empty));

        try
        {
            _httpClient.DefaultRequestHeaders.Authorization =
                new AuthenticationHeaderValue("Bearer", _accessService._apiToken);
            var response = await _httpClient.PostAsJsonAsync(uri, bills);
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/Bill/DeleteBill", string.Empty));
    ...
    public async Task<string> UploadFile(MultipartFormDataContent item, int id)
    {
        try
        {
            ...
            var request = new HttpRequestMessage(HttpMethod.Post,
                string.Format(_utilityServices.GetRestUrl() + $"api/Bill/UploadBill/{id}"));
