...
public class StatisticService : IStatisticService
{
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/Statistic/GetDashboard", string.Empty));
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/Statistic/GetBalanceLineChart",
            string.Empty));
    ...
    {
        var uri = new Uri(string.Format(_utilityServices.GetRestUrl() + $"api/Statistic/GetSalaryStatistics/{userId}",
            string.Empty));
